 ...
 */
export function ProfileHeader({ avatarUri, setAvatarUri, firstName, setFirstName, lastName, setLastName, streak }: any) {
            ...
            <View>
                <View style={styles.nameRow}>
                    <TouchableOpacity onPress={handleOpenModal}>
                        <Text>
                            <Text style={styles.usernameInput}>{firstName} {lastName} </Text>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        {avatarUri && (
                            <View style={{ width: '100%', margin: 15}}>
                                <TouchableOpacity style={[styles.button, { flex: 0, alignItems: 'center' }]} onPress={handleRemoveAvatar}>
